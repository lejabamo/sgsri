...
def guardar_controles_evaluacion():
    ...
    try:
        ...
        db.session.rollback()
        print(f"Error guardando controles: {str(e)}")
...
def obtener_controles_por_evaluacion(evaluacion_id):
    ...
    try:
        ...
        print(f"Error obteniendo controles: {str(e)}")
        return jsonify({'error': str(e)}), 500
...
def obtener_controles_usados():
    ...
    try:
        ...
        print(f"Error obteniendo controles usados: {str(e)}")
        return jsonify({'error': str(e)}), 500
...
def obtener_controles_por_riesgo(riesgo_id):
    ...
    try:
        ...
        print(f"Error obteniendo controles por riesgo: {str(e)}")
        return jsonify({'error': str(e)}), 500
