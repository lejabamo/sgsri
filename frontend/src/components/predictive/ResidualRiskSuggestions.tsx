      ...
      const mockSuggestions: ResidualRiskSuggestion[] = [
        {
          ...
          impacto: 'Menor',
          nivel: 'LOW',
          justificacion: 'Los controles de acceso y monitoreo implementados reducen significativamente la probabilidad de materialización del riesgo.',
        ...
        },
        {
          ...
          impacto: 'Alto',
          nivel: 'MEDIUM',
          justificacion: 'Los controles de seguridad reducen la probabilidad, pero el impacto alto se mantiene por la naturaleza crítica del activo.',
          controles_efectivos: ['Autenticación Multifactor', 'Auditoría de Seguridad'],
          confianza: 0.75,
          norma: 'ISO 27005'
        }
      ];
