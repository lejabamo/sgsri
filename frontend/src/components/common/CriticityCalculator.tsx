  ...
  const dimensions = [
    {
      ...
      icon: <SecurityIcon />,
      description: 'Nivel de protección de la información confidencial'
    },
    {
      key: 'disponibilidad',
    ...
    },
    {
      ...
      label: 'Integridad',
      icon: <IntegrityIcon />,
      description: 'Nivel de integridad y precisión de la información'
    }
  ];
      ...
      <CardContent>
        ...
        <Grid container spacing={3}>
          {dimensions.map((dimension) => (
            <Grid item xs={12} md={4} key={dimension.key}>
              <Box>
