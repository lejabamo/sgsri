...
const EstadisticasActivos: React.FC = () => {
  ...
  const cargarEstadisticas = async () => {
    try {
      ...
      toast.error('Error al cargar las estadísticas de activos');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <Box p={3}>
        <Alert severity="error">
          No se pudieron cargar las estadísticas de activos. Intente de nuevo más tarde.
        </Alert>
      </Box>
    );
  }
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Typography variant="body1" className="font-roboto" sx={{ color: '#6B7280', mb: 4 }}>
        Análisis detallado de la distribución y estado de los activos del sistema.
      </Typography>
