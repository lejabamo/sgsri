    ...
    return (
      <Box p={3}>
        <Alert severity="error">
          No se pudo cargar el reporte de usuarios. Intente de nuevo más tarde.
        </Alert>
      </Box>
    );
  }
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Typography variant="body1" className="font-roboto" sx={{ color: '#6B7280', mb: 4 }}>
        Análisis de evidencias subidas por usuarios: gestión de riesgo, mitigación, políticas, controles y contratos.
      </Typography>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        ...
        <Grid item xs={12} md={6}>
          <Card sx={{ borderRadius: '12px', boxShadow: 3 }}>
            <CardHeader
              title="Top 10 Usuarios con Más Documentos"
              titleTypographyProps={{ className: 'font-poppins', fontWeight: 600, color: '#1E3A8A' }}
            />
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
