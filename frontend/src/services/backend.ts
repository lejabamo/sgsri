      ...
      return [
        {
          ...
          descripcion: 'Servidor principal para aplicaciones web',
          propietario: 'Juan Pérez',
          ubicacion: 'Centro de Datos A'
        },
        {
          id: 2,
          nombre: 'Base de Datos CRM',
          tipo: 'Aplicación',
          estado: 'Activo',
          criticidad: 'Crítica',
          fecha_creacion: '2025-01-10',
          descripcion: 'Base de datos del sistema CRM',
          propietario: 'María García',
          ubicacion: 'Centro de Datos B'
        },
        {
          id: 3,
          ...
          descripcion: 'Firewall principal de la red corporativa',
  ...
  async getAll(): Promise<Riesgo[]> {
    try {
      ...
      return [
        {
          id: 1,
          nombre: 'Acceso no autorizado a BD',
          descripcion: 'Riesgo de acceso no autorizado a la base de datos principal',
          nivel: 'HIGH',
        ...
        },
        {
          ...
          descripcion: 'Posible falla del servidor web principal',
          nivel: 'MEDIUM',
          ...
          activo_id: 1,
          propietario: 'Juan Pérez',
          fecha_identificacion: '2025-01-14'
        },
        {
          id: 3,
          nombre: 'Vulnerabilidad de seguridad',
          descripcion: 'Vulnerabilidad detectada en el firewall',
          nivel: 'HIGH',
          ...
          activo_id: 3,
          propietario: 'Carlos López',
          fecha_identificacion: '2025-01-12'
        }
      ];
    }
  },
...
export const dashboardService = {
  ...
  ,
  // Obtener historial (últimos 12 meses y acumulado)
